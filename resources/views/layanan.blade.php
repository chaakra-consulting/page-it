                        ...
                        <div class="row">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 fw-semibold fs-5"> <!-- fs-5 = ~18px -->
                                    ...
                                    <li class="breadcrumb-item active text-fixed-dark" aria-current="page">Implementasi</li>
                                </ol>
                            </nav>                            
                        </div>
                    </div>
            ...
            <div class="container about-container">
                ...
                <div class="row about-main mb-5">
                    <div class="col-lg-8 col-md-8 col-sm-12 text-center">
                        <h1 class="mb-1 fw-semibold fs-46 mt-5">Implementasi</h1>
                    </div>
                </div>
                <!--End::row-1 -->
                 ...
                 <div class="row rounded-5">
                    <p>
                        <img src="{{ asset('/Tema/dist/assets/images/landing/implementasi-asset.jpg') }}"  class="rounded-2 w-100" style="max-height: 400px; object-fit: cover;" alt="image">
                    </p>
                </div>                
                <!--End::row-2 -->
                            ...
                            <div class="card-body p-0 p-lg-5 text-dark">
                                <div class="statistics-info p-4">
                                    <div class="row">
                                        <div class="col-xl-6">
                                            <div class="">
                                                <h2 class="fw-bold mb-4 text-dark">Bagaimana Metode Layanan Implementasi Sistem Kami?</h2>
